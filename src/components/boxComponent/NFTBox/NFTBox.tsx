    ...
    return (
        <div>
            <div className="NFTBox_box d-flex flex-column align-items-center border rounded m-2 shadow-sm">
                ...
                <div className="container-fluid m-0 w-100 p-0">
                    <div className={"row align-items-center p-3"}>
                        <div className="col-8"><h6 className={"p-0 m-0 w-100 text-break text-truncate " + loadingDataClass}>{NFTname}</h6></div>
                        {saleNFTStatus === false ? <div></div> :
                        <div className="col-4"><h6 className={"p-0 m-0 w-100 text-break text-truncate text-end "+ loadingDataClass}>{nftCost}</h6></div>}
                    </div>
                </div>
