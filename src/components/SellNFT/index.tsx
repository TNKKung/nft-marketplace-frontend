...
const SellNFT: React.FC = () => {
  ...
  const { readTokenURI, readOwnerTokenID, sellNFT, readCollabPercent } = useContracts();
        ...
        <div className="container mt-4">
          ...
          <div className="container-fluid border rounded p-2">
            ...
            <div className="row mt-3 justify-content-between">
              <div className="col-auto h6">Estimate total earnings ({blockchainName})</div>
              <div className="col-auto h6">{amountInput * ((100 - 2.5 - collabPercent) / 100)}</div>
            </div>
          </div>
